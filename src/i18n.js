...
export const STRINGS = {
  ...
  doneManaging: { zh: '完成管理', en: 'Done managing' },
  managingRewards: { zh: '可以新增、修改或刪掉獎勵了', en: 'You can add, edit or remove rewards' },
  errEditReward: { zh: '修改沒有成功{detail}，請再試一次。', en: "Couldn't save that change{detail}. Please try again." },
  ...
  activityNameZh: { zh: '中文名稱', en: 'Chinese name' },
  activityNameEn: { zh: '英文名稱', en: 'English name' },
  activityNameNeeded: { zh: '至少填一個名字', en: 'Fill in at least one name' },
